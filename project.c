...
if(standard>6)
{
printf("\nthe student is not eligeble for scholar badge :");
} 
else;
{ 
printf("\nthe student is eligeble for scholar badge:"); 

}

	printf("\nenter the student's parent's phone_number :");
	int phone_number [10] ;
...
printf("\nenter student's extra curricular activities :");
char ext[50];
scanf("%s",&ext);
	printf("********************************************************************************");
	printf("\nenter the grade for extra activity : \n1 A+ \n2 A \n3 B+ \n4 B");
	int choice2 = 0;
	scanf("%d" , &choice2);
	switch(choice2)
	{
...
printf(" \n***************************************************************************************");
	...
	printf("\nenter the grade for behaviour in school : \n1 A+ \n2 A \n3 B+ \n4 B");
	int choice3 = 0;
	scanf("%d" , &choice3);
	switch(choice3)
	{
...
printf("************************************************************************************");
	printf("\nenter the grade for parctical (COMPUTER) : \n1 A+ \n2 A \n3 B+ \n4 B");
	int choice4 = 0;
	scanf("%d" , &choice4);
	switch(choice4)
	{
...
printf("****************************************************************");
	printf("\nenter the grade for practical (MATHS) : \n1 A+ \n2 A \n3 B+ \n4 B");
	int choice5 = 0;
	scanf("%d" , &choice5);
	switch(choice5)
	{
...
default : printf("Invalid choice"); 
	...
	printf("\n************************************************");
	printf("\nenter the grade for student's participation in class : \n1 A+ \n2 A \n3 B+ \n4 B");
	int choice6 = 0;
	scanf("%d" , &choice6);
	switch(choice6)
	{
...
printf("MARKS IN MATHS %d : \n MARKS IN SCIENCE %d : \n MARKS IN ENGLISH %d : \n MARKS IN HINDI %d : \n MARKS IN SOCIAL STUDIES %d : " , num1 , num2 , num3 , num4 , num5);
